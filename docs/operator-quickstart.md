# Operator Quickstart — Equine-Facility Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0142** (`cloud-itonami-isic-0142`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0142.git
cd cloud-itonami-isic-0142
```
...
- Blueprint governor key: `equine-facility-operations-governor`
- Likely source path: `equineops.governor.cljc`
